...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles btnSelect.Click
        ...
        Dim Yr As Integer = txtYr.Text

        Dim query As String = "Insert into TB_one values (@Name, @Age, @Gender, @DateofBirth, @Address, @PhoneNumber, @Course, @Year)"
    ...
    Private Sub BindData()
        ...
        Dim query As String = " select * from TB_One "
        Using con As SqlConnection = New SqlConnection("Data Source=DESKTOP-O91ELP8\SQLEXPRESS;Initial Catalog=Enrollmentsystem;Integrated Security=True;Pooling=False")
            Using cmd As SqlCommand = New SqlCommand(query, con)
